...
public class TagsFilterSegmentActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String result = sharedPreferences.getString(getString(R.string.tags_filter_segment), "");
        if(!result.equals("")){
    ...
    public void onClick(View view) {
        ...
        switch (id){
            case R.id.btNextSegments:
                ...
                editor.putString(getString(R.string.tags_filter_segment), getString(R.string.done));
                editor.apply();
